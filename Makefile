...
OBJS := $(BUILD)/main.o $(BUILD)/scene1.o $(BUILD)/scene2.o $(BUILD)/scene3.o $(BUILD)/scene4.o $(BUILD)/scene5.o $(BUILD)/scene6.o $(BUILD)/scene7.o $(BUILD)/scene8.o $(BUILD)/c2p.o $(BUILD)/ptplayer.o $(BUILD)/music.o

# INITPOS=n starts the song (and the demo) at position n — debug aid
# for jumping straight to a scene (4=warhol 10=dots 13=dive 16=comic
# 20=conveyor 24=brillo 28=credits). Touch src/main.asm when changing it.
...
$(BUILD)/scene7.o $(BUILD)/scene8.o: src/custom.i
