...
CARDS = [
    [(46, "POPART", 60),
     (13, "A DEMO IN SIX PRINT RUNS", 150)],
    [(17, "MUSIC", 30),
     (13, '"DANCINONAMIGA" BY KATIE CADET', 60),
     (11, "PUBLIC DOMAIN - THE MOD ARCHIVE", 82),
     (17, "CODE + DIRECTION", 120),
     (13, "CLAUDE (FABLE 5)", 150),
     (17, "PRESS", 188),
     (11, "VASM  VLINK  PTPLAYER (FRANK WILLE)", 218)],
