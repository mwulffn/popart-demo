; demo-fable: Kalms c2p1x1_4_c5_gen (Public Domain, Mikael Kalms,
; github.com/Kalmalyzer/kalms-c2p) — pristine copy in tools/kalms-c2p/.
; Only change: fixed geometry for scene 3B (320x100 chunky, 4 bpl,
; plane stride 4000) via the BPLX/BPLY defines below.
BPLX	EQU	320
BPLY	EQU	100
